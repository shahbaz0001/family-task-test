...
namespace WebApi.Controllers
{
    ...
    public class TasksController : ControllerBase
    {
        ...
        public async Task<IActionResult> Update(Guid id, UpdateTaskCommand updateTaskCommand)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            try
            {
                var result = await _taskService.UpdateTaskCommandHandler(updateTaskCommand);
